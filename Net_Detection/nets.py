...
if __name__ == '__main__':
    mynet1 = TPCNN_C(num_class=13, head_payload=True)
    print(mynet1)

    # torch.save(mynet1, 'net1.pth')

    mynet1.load_state_dict(torch.load("D:/flaskProject/Net_Detection/model/pridect/model_best.pth.tar")['state_dict'], False)

    input= torch.randn((64,1,22,22))
    torch.onnx.export(mynet1, input, "./model2.onnx", verbose=False)
    print(1)